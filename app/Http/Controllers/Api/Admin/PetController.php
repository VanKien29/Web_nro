...
{
    public function __construct(private readonly PetService $pets)
    {
    }

    public function index(Request $request): JsonResponse
    {
        return $this->jsonResult($this->pets->list($request));
    }
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        return $this->jsonResult($this->pets->create($request));
    }

    public function show(int $id): JsonResponse
    {
        return $this->jsonResult($this->pets->get($id));
    }
    ...
    public function update(Request $request, int $id): JsonResponse
    {
        ...
        return $this->jsonResult($this->pets->update($request, $id));
    }

    public function destroy(int $id): JsonResponse
    {
        return $this->jsonResult($this->pets->delete($id));
    }
